				...
				<div class="row">
					<div class="col-md-8">
						...
						<ul class="nav nav-tabs style-4" role="tablist">
							...
							<li><a href="#h2tab3" role="tab" data-toggle="tab"><i class="fa fa-star pr-5"></i>(<?php echo count($one_book_reviews) ?>) Reviews</a></li>
						</ul>
						<!-- Tab panes -->
						<div class="tab-content padding-top-clear padding-bottom-clear">
							...
							<div class="tab-pane fade" id="h2tab3">
								<!-- comments start -->
								<div class="comments book_comments margin-clear space-top">
						                 
						                 <?php $this->load->view('BookDetail_page/render'); ?>
										<!-- comment end -->
									...
									<?php if($user){ ?>
										...
										<div class="comments-form">
											<?php if(empty($one_book_reviews)){ ?>
												<h2 class="title">Add  First  Review</h2>
											<?php } else { ?>
											...
											<div class="form-group has-feedback">
												...
												<textarea class="form-control" rows="8" id="review" placeholder="" name="message4" required></textarea>
												<i class="fa fa-envelope-o form-control-feedback"></i>
											</div>
											<button 
											id="review_btn"
											class="btn btn-info" 
											data-url = "<?php echo base_url("Book/review");?>"
											data-book_isbn = "<?php echo $book->isbn ?>"
