...
<div class="dark-bg banner pv-40">
				...
				<div id="slider-banner-boxedwidth" class="slider-banner-boxedwidth rev_slider" data-version="5.0">
					<ul class="slides">
						...
						<li data-transition="random" data-slotamount="default" data-masterspeed="default" data-title="Get 50% OFF">
							...
							<!-- main image -->
							<img src="<?php echo base_url('assets/')?>images/shop-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
	...
	<li class="text-right" data-transition="random" data-slotamount="default" data-masterspeed="default" data-title="New Arrivals">
		...
		<!-- main image -->
		<img src="<?php echo base_url('assets/')?>images/shop-slide-2.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<ul class="nav nav-pills" role="tablist">
					<li class="active"><a href="#pill-1" role="tab" data-toggle="tab" title="Latest Arrivals"><i class="icon-star"></i>ALL</a></li>
					<li><a href="#pill-2" role="tab" data-toggle="tab" title="Featured"><i class="icon-heart"></i>NEW books</a></li>
							...
							<div class="listing-item mb-20">
								<div class="row grid-space-0">
									...
									<div class="col-sm-6 col-md-8 col-lg-9">
										<div class="body">
											<h3 class="margin-clear"><a href="shop-product.html"><?php echo $book->name  ?></a></h3>
											...
											$sum = 0;
											$count = 0;
											$book_avgs = $this->Books_model->one_book_review(
												array(
													"book_id" => $book->id
											...
											<p> 
												<?php  $vote  =  round($avg); ?>
				           <i class="fa fa-star  <?php echo ($vote>=1) ? "text-default" : "" ?>"></i> 
							<i class="fa fa-star  <?php echo ($vote>=2) ? "text-default" : "" ?>" "></i>
							<i class="fa fa-star  <?php echo ($vote>=3) ? "text-default" : "" ?>""></i> 
							<i class="fa fa-star  <?php echo ($vote>=4) ? "text-default" : "" ?>""></i>
							<i class="fa fa-star <?php echo ($vote==5) ? "text-default" : "" ?>""></i> 

												
												<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
											</p>
											<p><?php echo  word_limiter($book->description, 50) ?></p>
											<div class="elements-list clearfix">
												<?php if($book->discount != 0){ ?>
													<span class="price"><del>$<?php echo $book->price  ?></del> $<?php echo 
													$x = $book->price-($book->discount*$book->price)/100
													?></span>
												<?php } else { ?>
													<span class="price"> $<?php echo $book->price
													?></span>
												<?php } ?>
												<a href="<?php echo base_url("book_detail/$book->id") ?>" class="pull-right btn btn-sm btn-default-transparent btn-animated">Info<i class="fa fa-info"></i></a>
												<a href="#"
												class=" mr-3 basket_btn pull-right btn btn-sm btn-default-transparent btn-animated"
												data-url = "<?php echo base_url('Home/basket_add') ?>"
												data-bookid = "<?php echo $book->id ?>"
												data-bookname = "<?php echo $book->name ?>"
												data-bookprice = "<?php echo $book->price ?>"
												>Add to Basket<i class="fa fa-shopping-cart"></i></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="tab-pane" id="pill-2">
						...
						<div class="listing-item mb-20">
							<div class="row grid-space-0">
								<div class="col-sm-6 col-md-4 col-lg-3">
									<div class="overlay-container">
										<img src="<?php echo base_url('assets/')?>images/product-7.jpg" alt="">
										<a class="overlay-link" href="shop-product.html"><i class="fa fa-plus"></i></a>
										<span class="badge">30% OFF</span>
									</div>
								</div>
						...
						<div class="listing-item mb-20">
							<div class="row grid-space-0">
								<div class="col-sm-6 col-md-4 col-lg-3">
									<div class="overlay-container">
										<img src="<?php echo base_url('assets/')?>images/product-6.jpg" alt="">
										<a class="overlay-link" href="shop-product.html"><i class="fa fa-plus"></i></a>
						...
						<div class="listing-item mb-20">
							<div class="row grid-space-0">
								<div class="col-sm-6 col-md-4 col-lg-3">
									<div class="overlay-container">
										<img src="<?php echo base_url('assets/')?>images/product-8.jpg" alt="">
										<a class="overlay-link" href="shop-product.html"><i class="fa fa-plus"></i></a>
							...
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<div class="listing-item">
										<div class="overlay-container">
											<img src="<?php echo base_url('assets/')?>images/product-1.jpg" alt="product 1">
											<span class="badge">30% OFF</span>
								...
								<div class="item">
									<div class="listing-item">
										<div class="overlay-container">
											<img src="<?php echo base_url('assets/')?>images/product-2.jpg" alt="product 2">
											<span class="badge">20% OFF</span>
											<a href="shop-product.html" class="overlay-link"><i class="fa fa-link"></i></a>
										</div>
								...
								<div class="item">
									<div class="listing-item">
										<div class="overlay-container">
											<img src="<?php echo base_url('assets/')?>images/product-3.jpg" alt="product 3">
											<span class="badge">40% OFF</span>
											<a href="shop-product.html" class="overlay-link"><i class="fa fa-link"></i></a>
										</div>
			...
			<div class="col-md-4">
				<div class="block clearfix">
					...
					<div class="media margin-clear">
						<div class="media-left">
							<div class="overlay-container">
								<img class="media-object" src="<?php echo base_url('assets/')?>images/product-1.jpg" alt="blog-thumb">
								<a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
							</div>
						</div>
						<div class="media-body">
					...
					<div class="media margin-clear">
						<div class="media-left">
							<div class="overlay-container">
								<img class="media-object" src="<?php echo base_url('assets/')?>images/product-2.jpg" alt="blog-thumb">
								<a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
							</div>
						</div>
						<div class="media-body">
					...
					<div class="media margin-clear">
						<div class="media-left">
							<div class="overlay-container">
								<img class="media-object" src="<?php echo base_url('assets/')?>images/product-3.jpg" alt="blog-thumb">
								<a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
							</div>
						</div>
						<div class="media-body">
					...
					<div class="media margin-clear">
						<div class="media-left">
							<div class="overlay-container">
								<img class="media-object" src="<?php echo base_url('assets/')?>images/product-4.jpg" alt="blog-thumb">
								<a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
							</div>
						</div>
						<div class="media-body">
...
<!-- section start -->
<!-- ================ -->
<section class="section dark-translucent-bg pv-40" style="background-image:url('<?php echo base_url("assets/") ?>images/shop-banner.jpg');background-position: 50% 32%;">
	<div class="container">
